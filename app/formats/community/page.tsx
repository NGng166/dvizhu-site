  ...
  const format = {
    ...
    content: [
      ...
      },
      {
        type: "slider",
        photos: [
          { src: "/formats/community/slider3.jpg", alt: "FLAT-вечеринка 3" },
          { src: "/formats/community/community-wide.jpg", alt: "FLAT-вечеринка 1" },
          { src: "/formats/community/slider1.jpg", alt: "FLAT-вечеринка 2" },
          { src: "/formats/community/slider2.jpg", alt: "FLAT-вечеринка 3" },
          { src: "/formats/community/slider4.jpg", alt: "FLAT-вечеринка 3" },
        ]
      },      
      {
        type: "text",
    ...
    events: [
      ...
      { title: "FLAT | 27 сентября", date: "27 сентября 2025", slug: "flat-27-09", image: "/formats/community/flat-sept.jpg" },
      { title: "BEERPONG", date: "20 сентября 2025", slug: "beerpong-20-09", image: "/beerpong-20-09/beerpong-20-09.jpg" },
      { title: "Сбор перед концертом Макса Коржа", date: "31 августа 2025", slug: "max-korzh-gathering-31-08", image: "/formats/community/max-korzh.jpg" },
      { title: "Общий сбор в Дустаре", date: "14 августа 2025", slug: "obshe-sbor-14-08", image: "/obshe-sbor-14-08/obshe-sbor-14-08.webp" },
      { title: "Пейнтбол", date: "27 июля 2025", slug: "paintball-27-07", image: "/formats/community/paintball.jpg" },
      ...
      { title: "Новогодний корпоратив", date: "19 декабря 2025", slug: "newyear-corporate-19-12", image: "/formats/community/newyear.jpg" },
      { title: "Квартирник и настольные игры", date: "16 февраля 2025", slug: "kvartirnik-16-02", image: "/formats/community/kvartirnik.jpg" },
      { title: "Квартирник | 27 апреля", date: "27 апреля 2025", slug: "kvartirnik-27-04", image: "/formats/community/kvartirnik-apr.jpg" },
    ],
  };
...
{format.content.map((block, i) => {
  if (block.type === "text") {
    return (
      <p key={i} className="text-lg leading-relaxed text-justify indent-6 text-gray-200">
        {block.text}
      </p>
    );
  } else if (block.type === "image") {
    return (
      <div key={i} className="my-6 w-full max-w-4xl mx-auto rounded-xl overflow-hidden shadow-lg">
        <img src={block.src} alt={block.alt || ""} className="w-full object-cover rounded-xl" />
      </div>
    );
